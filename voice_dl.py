...
class DownloadDialog(QDialog):
    ...
    def initUI(self):
        ...
        self.label = QLabel("Download Progress:\n(whisper.cpp + whisper-large-v3-q5, total ~1.1GB)", self)
    ...
    def extract_files(self):
        pkgs_directory = os.path.abspath('./whisper')
        ...
        for dest_filename in self.dests:
            ...
            if dest_filename == "ggml-large-v3-q5_0.bin":
                os.rename((os.path.join(os.path.abspath('./temp'), dest_filename)),
                          (os.path.join(os.path.abspath('./whisper'), dest_filename)))
